...
public class AdminOrderMessageEmail {
    ...
    public static String createProcessingEmailMessage(Long orderId, OrderStatus newStatus) {
    ...
    public static String createCompletedEmailMessage(Long orderId, OrderStatus newStatus) {
    ...
    public static String createRefundEmailMessage(Long orderId, OrderStatus newStatus) {
